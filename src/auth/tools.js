...
exports.verifyRefreshToken = exports.verifyRefreshJWT = exports.verifyJWT = exports.JWTAuth = void 0;
...
const generateJWTToken = (payload) => new Promise((resolve, reject) => jsonwebtoken_1.default.sign(payload, process.env.JWT_SECRET, { expiresIn: "1h" }, (err, token) => {
    if (err)
        reject(err);
    else
        resolve(token);
